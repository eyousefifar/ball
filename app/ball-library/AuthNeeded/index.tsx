...
import {dismissCancelReserve} from "../../reservationList2/library/nav";
				...
				<View style={styles.container}>
					...
					<View style={styles.cardContainer}>
						...
						<View style={styles.two_buttons}>
							...
							<RectButton style={[styles.reserve_button, {backgroundColor: '#fff'}]} onPress={onAuthPress}>
								<Text style={[styles.reserve_button_text, {color: Colors.primaryPurple}]}>ورود و ثبت نام</Text>
							</RectButton>
