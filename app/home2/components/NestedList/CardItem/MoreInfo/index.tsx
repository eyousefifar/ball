...
const MoreInfoItem = (props: MoreInfoItem) => {
	...
	const {name, iconName, icon_type, color, text_color} = props;

	return (
			<View style={styles.more_info}>
				<Text style={[styles.more_info_text, text_color ? {color: props.text_color} : {color: Colors.grayBall}]}>{name}</Text>
